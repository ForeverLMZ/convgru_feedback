...
parser.add_argument('--graph_loc', type = str, default = '/home/mila/m/mingze.li/graph_csv/topdown_test_apical.csv')
...
parser.add_argument('--model_save', type = str, default = 'saved_models/topdown_test_apical.pt')
parser.add_argument('--results_save', type = str, default = 'results/topdown_test_apical.npy')
