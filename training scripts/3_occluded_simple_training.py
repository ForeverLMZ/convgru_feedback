...
parser.add_argument('--model_save', type = str, default = 'saved_models/topdown_test_mult_only.pt')
parser.add_argument('--results_save', type = str, default = 'results/topdown_test_mult_only.npy')
