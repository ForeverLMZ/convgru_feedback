...
parser.add_argument('--graph_loc', type = str, default = '/home/mila/m/mingze.li/graph_csv/topdown_test_mult_only.csv')
...
parser.add_argument('--model_save', type = str, default = 'saved_models/4_topdown_test_mult_only.pt')
parser.add_argument('--results_save', type = str, default = 'results/4_topdown_test_mult_only.npy')
...
test_occluded_mnist = torch.load('/home/mila/m/mingze.li/datasets/single_image_mnist_test_32.pt')
train_occluded_mnist = torch.load('/home/mila/m/mingze.li/datasets/single_image_mnist_train_32.pt')
...
output_node = 2 #C
input_dims = [1, 0, 0]
input_sizes = [(32, 32), (0, 0), (0, 0)]
graph_loc = args['graph_loc']
graph = Graph(graph_loc, input_nodes=input_node, output_node=2)
